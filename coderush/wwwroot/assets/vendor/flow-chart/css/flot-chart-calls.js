...
$(function() {
    ...
    $.plot($("#lineChart"), [lineData], lineOptions);
});
...
$(function() {
    ...
    var plot = $.plot("#liveChart", series, options);
	// Update chart with setTimeout
    var updateInterval = 30;
    function update() {
        plot.setData([series[0].data = getRandomData()]);
        plot.setData(series);
        plot.draw();

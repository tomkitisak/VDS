...
$(function () {
	...
	$('#bs-multiselect-4').multiselect({
		...
		templates: {
			...
			filterClearBtn: '<span class="input-group-append"><button class="btn btn-default multiselect-clear-filter" type="button"><i class="mdi mdi-close md-18"></i></button></span>',
		}
	});

...
function flowjs() {
	...
	r.on('fileAdded', function (file) {
		...
		$('.flow-list').append(
			...
			'<button type="button" class="flow-file-download btn btn-sm mr-2 btn-outline-primary"><i class="mdi mdi-download"></i></button>' +
			'<button type="button" class="flow-file-pause btn btn-sm mr-2 btn-outline-warning"><i class="mdi mdi-pause"></i></button> ' +
			'<button type="button" class="flow-file-resume btn btn-sm mr-2 btn-outline-success"><i class="mdi mdi-play"></i></button> ' +
			'<button type="button" class="flow-file-cancel btn btn-sm mr-2 btn-outline-danger"><i class="mdi mdi-close"></i></button>' +
			'</div>' +
			'</div>' +
			'</li>'
		);
